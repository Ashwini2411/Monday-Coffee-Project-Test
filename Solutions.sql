...
--If we want each city and their revenue (to get the city name)
SELECT
	ci.city_name,
...
--Who purchase product id from 1 to 14...because 1 to 14 have the coffee category products
...
-- each city and total rent /total cust
WITH city_table
AS
(
SELECT
